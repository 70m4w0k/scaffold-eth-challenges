...
- [x] Is it possible to predict the random number for any given roll? yes
...
- [x] Is anyone able to call the withdraw function? What would be the downside to that? onlyOwner
...
- [x] deployed at : tearful-clover.surge.sh
...
## verified address : 0x37e41d18CC15710b3124aD2627984d42eFba34F4
